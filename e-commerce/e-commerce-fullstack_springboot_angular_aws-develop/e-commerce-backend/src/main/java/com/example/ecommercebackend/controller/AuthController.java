...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        ...
        System.out.println("Received roles from frontend: " + strRoles);
        ...
        // Debug: Log the assigned roles
        System.out.println("User '" + user.getUserName() + "' assigned roles: " + 
            roles.stream().map(role -> role.getRoleName().name()).collect(Collectors.joining(", ")));
